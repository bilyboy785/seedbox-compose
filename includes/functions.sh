...
function script_option() {
	...
	echo ""
	echo -e "	${WHITE}[1] ${GREEN}Install the Seedbox${NC}"
	echo -e "	${WHITE}[2] ${GREEN}Add an user to the Htaccess${NC}"
	echo -e "	${WHITE}[3] ${GREEN}Add a docker App${NC}"
	echo -e "	${WHITE}[4] ${GREEN}Restart docker machines${NC}"
	echo -e "	${WHITE}[5] ${GREEN}Backup dockers conf${NC}"
	echo -e "	${WHITE}[6] ${GREEN}Delete and clean all Dockers${NC}"
	echo ""
